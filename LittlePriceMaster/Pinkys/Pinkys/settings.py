"""
Django settings for Pinkys project.
...
SECRET_KEY = 'z8s5pfy9hu!7f&^d$ut$saw*t9y1u8_d^$6ipscpdyz3qs*q8c'
...
WSGI_APPLICATION = 'Pinkys.wsgi.application'
